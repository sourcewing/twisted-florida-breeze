...
const MenuHighlights = () => {
  ...
  return (
    ...
    >
      {/* Centered, padded container so nothing gets cut off on mobile */}
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-10">
          {categories.map((cat) => (
            <div key={cat.title} className="space-y-6 max-w-xl mx-auto">
              <h3 className="font-heading text-2xl text-gold border-b border-gold/30 pb-3 text-center md:text-left">
                {cat.title}
              </h3>
              ...
              {cat.items.map((item) => (
                ...
                >
                  ...
                  {item.price ? (
                    <span className="text-gold font-heading text-lg md:whitespace-nowrap">
                      {item.price}
                    </span>
                  ) : null}
                </div>
